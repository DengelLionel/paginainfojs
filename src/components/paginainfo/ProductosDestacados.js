...
console.log("destacados",dato)
 ...
 <CuadroProductos key={index} imagen={destacados.product_imagen[0].imagen} titulo={destacados.nombre} link={`/producto/${destacados.meta_title_link}`}/>
      ))}
