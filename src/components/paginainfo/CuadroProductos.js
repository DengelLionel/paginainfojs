...
const CuadroProductos = ({ imagen, titulo, link, nuevo, oferta }) => {
    ...
    return (
        <div
            onClick={handleClick}
            className="relative cursor-pointer w-[322px] h-[365px] lg:w-[279px] lg:h-[330px] border-[2px] border-gray-400 border-opacity-25 shadow-lg lg:shadow-2xl rounded-md bg-blancoTwo flex flex-col justify-center items-center p-[10px] group">
