    ...
    return (
        <div className="flex flex-col w-full lg:w-[800px] justify-center items-left lg:justify-start lg:items-start">
            ...
            <Link
                ...
                download={true}
                className="text-sm border border-blueOne bg-blueOne text-white rounded-full px-4 py-2 m-2 transition text-center duration-500 ease select-none hover:bg-blue-600 focus:outline-none focus:shadow-outline w-[170px]">
                Ficha Técnica
            </Link>
        </div>
    )
