...
const HeaderMobil= ({ logo}) => {
    ...
    return (
      <div ref={toggleContainer}>
        <div className={`bg-black md:hidden fixed top-0  z-[40] w-full h-[64px] items-center pt-[16px] pb-[16px]`}>
          <section className='flex justify-between '>
            <section >
              {logo}
            </section> 
            <div className='mr-[16px]'> <IconMenuOne open={()=>setOpenMenu(!openMenu)} /></div>
